...
class MainWindow(QMainWindow):
    ...
    def launch_update_installer_and_exit(self, installer_path: Path) -> None:
        ...
        append_update_log(
            f"Launching installer directly installer={installer_path} installer_log={installer_log}"
        )
        subprocess.Popen(
            [
                str(installer_path),
        ...
        append_update_log("Installer launch requested successfully")
        self.show_status("Closing SyncRoom so the installer can finish the update...")
